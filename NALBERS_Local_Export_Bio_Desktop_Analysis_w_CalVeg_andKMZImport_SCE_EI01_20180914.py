# -*- coding: utf-8 -*-
# ---------------------------------------------------------------------------
# Bio_Desktop_Analysis_EI01_20161129.py
# Created on: 2016-11-29 13:34:58.00000
...
#----Only fill in the variables in the section below - All others are automatically generated or point to existing data on the L Drive.----------------------------------------------------
EI_Version = "01" #Use two digits
EI_Date = "20180921_CWA048_135"
#ExportPaths
Boundary_Dataset_Path = r'C:\Users\nalbers\Downloads\Bio_Desktop_Outputs.gdb\Boundaries'
Processing_Dataset_Path = r'C:\Users\nalbers\Downloads\Bio_Desktop_Outputs.gdb\Bio'
Bio_Dataset_Path = r'C:\Users\nalbers\Downloads\Bio_Desktop_Outputs.gdb\Bio'
Excel_Table_Path = r'C:\Users\nalbers\Downloads\Excel_Desktop_Output'
KMZ_Path = r'C:\Users\nalbers\Downloads\KMZ_Desktop_Output'
...
KMZ_Input = r'I:\SCE\On-Call Environmental Services\CWA_048_DetPoles_Blanket\CWA048_135_TD1417139_DP_Private\03_Resources\received_data\20180816_receivedfrom_EHSync\TD1417139_SWCA.kmz'

#Background Data
County = r'G:\Data\GIS\Cal_GIS\1_24000_County.shp'
TownSecRange = r'G:\Data\GIS\Cal_GIS\plsa\plsa_utm.shp'
Quadrangle = r'G:\Data\GIS\Cal_GIS\Quad boundaries\mapgrida\mapgrida_utm.shp'
City = r'G:\Data\GIS\Cal_GIS\Incorporated Cities\incorp16_1_shape\incorp16_1.shp'
BLM_LandFile = r'G:\Data\GIS\BLM\LandStatus_v10.gdb\LndSurfaceEstate_SMA'
CPAD_LandFile = r'G:\Data\GIS\California Protected Areas\CPAD_2016a\CPAD_2016a\CPAD_2016a_SuperUnits.shp'
USFS_LandFile = r'G:\Data\GIS\USFS\S_USA.Ownership_P.gdb\Ownership_P'
HTRP_LandOwner = r'G:\SCE\HTRP_DTRP_2016\03_GIS_Data\geodatabases\HTRP_DTRP_TAS\DRP_HTRP_TAS_EI01_20160517.gdb\Model_Features\Land_Ownership_EI01_20160429'

#Bio Data
CritHabPoly = r'G:\Data\GIS\USFWS\CriticalHabitat\Combined_Species\CRITHAB_POLY.shp'
CritHabLine = r'G:\Data\GIS\USFWS\CriticalHabitat\Combined_Species\CRITHAB_LINE.shp'
CNDDB = r'G:\Data\GIS\CDFW\CNDDB\Shapefiles\cnddb.shp'
#OLD_CritHabPoly = r'G:\Data\GIS\USFWS\CriticalHabitat\20160825\CRITHAB_POLY.shp'
#OLD_CritHabLine = r'G:\Data\GIS\USFWS\CriticalHabitat\20160825\CRITHAB_LINE.shp'
#OLD_NWI_wet = r'C:\Users\nalbers\Downloads\CA_wetlands\CA_wetlands.gdb\CA_Wetlands' #need to copy to network
#OLD_NWI_rip = r'C:\Users\nalbers\Downloads\CA_wetlands\CA_wetlands.gdb\CA_Riparian' #need to copy to network
#OLD_NHD = r'G:\Data\GIS\Wetlands_and_Waters\NHD\NHD_H_06_GDB\NHD_H_06_GDB.gdb\Hydrography\NHDFlowline'#need field calculator script for what flowline codes mean
NWI_wet = r'G:\Data\GIS\Wetlands_and_Waters\CA_wetlands\CA_geodatabase_wetlands.gdb\CA_Wetlands' #need to copy to network
NWI_rip = r'G:\Data\GIS\Wetlands_and_Waters\CA_wetlands\CA_geodatabase_wetlands.gdb\CA_Riparian' #need to copy to network
NHD = r'G:\Data\GIS\Wetlands_and_Waters\NHD\NHD_H_California_State_GDB.gdb\Hydrography\NHDFlowline'#need field calculator script for what flowline codes mean
#LandPlanningAreas = r'G:\Data\GIS\BLM\LndUsePlans_v10.gdb\lupa\lupa_exist_poly' #BLM
LandPlanningAreas = r'C:\Users\nalbers\Downloads\ds760\ds760.shp' #NCCP_HCPs
#CCH = Need to download all and ensure all records in each County
#CalVeg = r'C:\Users\nalbers\Downloads\ExistingVegSouthCoast2002_2010_v2\ExistingVegSouthCoast2002_2010_v2_UTM.shp' #South Coast Region
CalVeg = r'G:\Data\GIS\Cal_GIS\CALveg\CentralValley_1998_2007_v1_UTM\CentralValley_1998_2007_v1_UTM.shp' #Central Valley Region
#CalVeg = r'G:\Data\GIS\Desert Renewable Energy Conservation Plan\ds735.gdb\ds735' # DRECP
#CoastalZone = r'G:\Data\GIS\Coastal Zone\Coastal_Zone_Layer_fromSCE_20170103.gdb\Placemarks\Polygons'
#ACEC = review if this is the correct file - r'G:\Data\GIS\BLM\Acec_v10.gdb\Acec\acec_desig_poly'
CFWO_Spp = r'G:\Data\GIS\USFWS\Species Occurrence Data\Carlsbad_FWO\Species_Occurrence_Polys.shp'

#Exports
#KMZ_to_GDB_Export
KMZ_Output_Folder_Location = r'C:\Users\nalbers\Downloads\temp_Shapefiles'
KMZ_File_Output_Name = 'Pole_Locations_fromSCEkmz_EI'+EI_Version+'_'+EI_Date
...
#KMZ_to_FeatureClass
Reprojection_Input_File = r'C:\Users\nalbers\Downloads\temp_Shapefiles'+"\\"+KMZ_File_Output_Name+r'.gdb\Placemarks\Points'
#Reprojection_Input_File = r'C:\Users\nalbers\Downloads\temp_Shapefiles'+"\\"+KMZ_File_Output_Name+r'.gdb\Placemarks\Polygons'
...
print "KMZ Import Completed"

now = datetime.datetime.now()
Start_Time01 = str(now.year) + str(now.month) + str(now.day) +'_'+str(now.hour)+'h' + str(now.minute)+'m' + str(now.second)+'s'
print Start_Time01
...
print "100-ft Buffer completed"
arcpy.Buffer_analysis(Buffer_100ft, Buffer_3Mile, "3 Miles", "FULL", "ROUND", "ALL", "", "PLANAR")
print "3-Mile Buffer completed"

now = datetime.datetime.now()
Start_Time1 = str(now.year) + str(now.month) + str(now.day) +'_'+str(now.hour)+'h' + str(now.minute)+'m' + str(now.second)+'s'
print Start_Time1
...
print "Crit Hab Poly Spatial Join completed"
...
arcpy.AddField_management(CNDDB_SpatialJoin, "OccDate", "TEXT", "", "", "255", "", "NULLABLE", "NON_REQUIRED", "")
arcpy.AddField_management(CNDDB_SpatialJoin, "OccDateDes", "TEXT", "", "", "255", "", "NULLABLE", "NON_REQUIRED", "")
...
arcpy.CalculateField_management(CNDDB_SpatialJoin, "OccDate", "!ELMDATE!.replace('X','0')", "PYTHON_9.3", "")

fields_in_cursor = ["OccDate", "OccDateDes"]
with arcpy.da.UpdateCursor(CNDDB_SpatialJoin, fields_in_cursor) as cursor:
        for row_field_Name in cursor:
                if row_field_Name[0] > '2007%':
                        row_field_Name[1] = 'Within 10 years'
                elif row_field_Name[0] > '1992%':
                        row_field_Name[1] = 'Within 25 years'
                elif row_field_Name[0] > '1942%':
                        row_field_Name[1] = 'Within 75 years'
                elif row_field_Name[0] == '00000000':
                        row_field_Name[1] = 'No Year Recorded'
                else:
                        row_field_Name[1] = 'Not Within 75 years'
...
fields_in_cursor = ["DATE_", "OccDateDes"]
with arcpy.da.UpdateCursor(CFWO_Spp_SpatialJoin, fields_in_cursor) as cursor:
        for row_field_Name in cursor:
                if row_field_Name[0] > 20070000:
                        row_field_Name[1] = 'Within 10 years'
                elif row_field_Name[0] > 19920000:
                        row_field_Name[1] = 'Within 25 years'
                elif row_field_Name[0] > 19420000:
                        row_field_Name[1] = 'Within 75 years'
                else:
                        row_field_Name[1] = 'Not Within 75 years'
                cursor.updateRow(row_field_Name)

print "Distance fields are complete"
...
mxd = arcpy.mapping.MapDocument(r'C:\Users\nalbers\Downloads\Symbolizing.mxd')
df = arcpy.mapping.ListDataFrames(mxd, "DesktopDataAnalysis")[0]
updateLayer = arcpy.mapping.Layer(CNDDB_SpatialJoin)
sourceLayer = arcpy.mapping.Layer(r'G:\Data\GIS\00_Scripts\Layer_Files_for_KMZ_Symbology\CNDDB_CName_All_Example.lyr')
...
arcpy.ApplySymbologyFromLayer_management(newLayer, r'G:\Data\GIS\00_Scripts\Layer_Files_for_KMZ_Symbology\StudyArea_Boundary_100ft_Buff.lyr')
arcpy.mapping.AddLayer(df, newLayer, "BOTTOM")

mxd.save()
print "CNDDB and Study Area symbology updated"

#Process: Export to KML
tempLayer = r'C:\Users\nalbers\Downloads\KMZ_Desktop_Output\tempLayer'
...
print "Export to KMZ finished"

now = datetime.datetime.now()
End_Time = str(now.year) + str(now.month) + str(now.day) +'_'+str(now.hour)+'h' + str(now.minute)+'m' + str(now.second)+'s'
print End_Time
print "Doneski"
